...
export default function AfternoonSummary() {
  ...
  useEffect(() => {
    const storedData = localStorage.getItem('afternoonFormData');
    if (storedData) {
  ...
  const generatePDF = async () => {
    ...
    pdf.save('afternoon-report-summary.pdf');
  };
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-center">
          ...
          <Link href="/afternoon" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-200">
            Go to Form
          </Link>
        </div>
      </div>
